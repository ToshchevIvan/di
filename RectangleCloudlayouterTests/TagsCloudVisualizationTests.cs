...
namespace RectangleCloudlayouterTests
{
    ...
    {
        // Тесты пока только на прямоугольники. Хотя разницы никакой
        ...
        public void TearDown()
        {
            ...
            using (var painter = new BitmapRectangleCloudDrawer(new Size(CanvasSideLength, CanvasSideLength)))
            {
        ...
        {
            Action act = () => new SpiralRectanglesLayouter(new Point(-10, -10));
