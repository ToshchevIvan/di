...
namespace RectangleCloudlayouterTests
{
    internal static class RandomEntitiesFabric
    {
        ...
        public static SpiralRectanglesLayouter GetRandomLayouter(int canvasSideLength)
        {
            ...
            return new SpiralRectanglesLayouter(
        ...
        public static IEnumerable<Rectangle> GetRandomLayout(IRectanglesLayouter layouter, int rectCount)
        {
